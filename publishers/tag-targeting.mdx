...
<img
  ...
  src="/assets/images/element-targeting--light.png"
  alt="Preview of the config targeting field in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/element-targeting--dark.png"
  alt="Preview of the config targeting field in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/viewport-filter--light.png"
  alt="Preview of the viewport filter field in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/viewport-filter--dark.png"
  alt="Preview of the viewport filter field in Fusion"
/>
