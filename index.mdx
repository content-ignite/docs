...
<Columns cols={2}>
  <Card
    ...
    icon="pen-to-square"
    href="/getting-started/saas-vs-pap"
  >
  ...
  <Card
    ...
    icon="palette"
    href="/getting-started/pro-vs-mapped"
  >
    If you choose to go the "SaaS" route, you have control over the ad unit
    structure inside your GAM
  </Card>
  <Card title="Our Ad Units" icon="map" href="/getting-started/ad-units">
...
<Steps>
  <Step title="Signing up" href="/getting-started/signing-up">
    Create your account and verify your email address
  </Step>
  <Step
    title="Creating your first publisher"
    href="/getting-started/first-publisher"
  >
    Get your publisher verified and approved
  </Step>
  <Step
    title="Creating your first tag config"
    href="/getting-started/first-tag-config"
  >
    Configs provide everything needed to serve an ad
  </Step>
  <Step title="Going live" href="/getting-started/going-live">
