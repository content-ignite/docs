...
<img
  ...
  src="/assets/images/insights-hub-revenue-analytics--light.png"
  alt="Preview of the revenue analytics insights report in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-revenue-analytics--dark.png"
  alt="Preview of the revenue analytics insights report in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-revenue-analytics-single-view--light.png"
  alt="Preview of the users tab inside the revenue analytics insights report in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-revenue-analytics-single-view--dark.png"
  alt="Preview of the users tab inside the revenue analytics insights report in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-revenue-analytics-connected--light.png"
  alt="Preview of the instructions presented in Fusion for connecting in Google Analytics"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-revenue-analytics-connected--dark.png"
  alt="Preview of the instructions presented in Fusion for connecting in Google Analytics"
/>
