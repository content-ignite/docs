...
<img
  ...
  src="/assets/images/insights-hub-adstxt--light.png"
  alt="Preview of the ads.txt insights report in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt--dark.png"
  alt="Preview of the ads.txt insights report in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-relationships--light.png"
  alt="Shows the relationship type tile in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-relationships--dark.png"
  alt="Shows the relationship type tile in the ads.txt insights report"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-exchanges--light.png"
  alt="Shows the exchanges tile in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-exchanges--dark.png"
  alt="Shows the exchanges tile in the ads.txt insights report"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-filelines--light.png"
  alt="Shows the file lines chart in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-filelines--dark.png"
  alt="Shows the file lines chart in the ads.txt insights report"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-yourfile--light.png"
  alt="Shows the detailed breakdown of an ads.txt file line by line in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-yourfile--dark.png"
  alt="Shows the detailed breakdown of an ads.txt file line by line in the ads.txt insights report"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-exchange-insights--light.png"
  alt="Shows a table with exchange data broken out in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-exchange-insights--dark.png"
  alt="Shows a table with exchange data broken out in the ads.txt insights report"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-adstxt-exchange-insights-modal--light.png"
  alt="Shows a modal presenting the lines that correspond to the given exchange in the ads.txt insights report"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-adstxt-exchange-insights-modal--dark.png"
  alt="Shows a modal presenting the lines that correspond to the given exchange in the ads.txt insights report"
/>
