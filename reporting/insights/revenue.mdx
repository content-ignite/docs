...
<img
  ...
  src="/assets/images/insights-hub-revenue--light.png"
  alt="Preview of the revenue insights report in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-revenue--dark.png"
  alt="Preview of the revenue insights report in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-revenue-single-publisher--light.png"
  alt="Shows the warning in platform when a publisher filter is preventing the publisher overview tab from populating"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-revenue-single-publisher--dark.png"
  alt="Shows the warning in platform when a publisher filter is preventing the publisher overview tab from populating"
/>
