...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-header--light.png"
  alt="Shows the common header of the insights hub group of reports"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-header--dark.png"
  alt="Shows the common header of the insights hub group of reports"
/>
