...
<img
  ...
  src="/assets/images/insights-hub-diagnostics--light.png"
  alt="Preview of the diagnostics insights report in Fusion"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-diagnostics--dark.png"
  alt="Preview of the diagnostics insights report in Fusion"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/insights-hub-diagnostics-tiles--light.png"
  alt="Shows a snapshot of the diagnostic tiles and the simple traffic light system used to highlight issues"
/>
<img
  className="block dark:block"
  src="/assets/images/insights-hub-diagnostics-tiles--dark.png"
  alt="Shows a snapshot of the diagnostic tiles and the simple traffic light system used to highlight issues"
/>
