...
<img
  className="block dark:hidden"
  src="/assets/images/ad-stack-the-works--light.png"
  alt="Various ad demand SSPs, an ad server and some fallback creatives within an ad stack"
/>
<img
  className="block dark:block"
  src="/assets/images/ad-stack-the-works--dark.png"
  alt="Various ad demand SSPs, an ad server and some fallback creatives within an ad stack"
/>
...
<img
  className="block dark:hidden"
  src="/assets/images/ad-stack-multi-server--light.png"
  alt="A full ad stack set up, with two ad servers"
/>
<img
  className="block dark:block"
  src="/assets/images/ad-stack-multi-server--dark.png"
  alt="A full ad stack set up, with two ad servers"
/>
