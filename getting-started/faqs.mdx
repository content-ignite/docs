...
<AccordionGroup>
    <Accordion title="How do I reach out for additional support?">
    ...
    <Accordion title="Just one tag on page? really? How would we target units?">
    ...
    <Accordion title="What does your tag look like?">
    ...
    <Accordion title="What creative file types can we use for direct campaigns?">
    ...
    <Accordion title="How can I stop particular advertisers advertising on certain sites?">
    ...
    <Accordion title="Migrating over from Google Publisher Tag">
    ...
    <Accordion title="How do SaaS setups work?">
    ...
    <Accordion title="For SaaS, do we need to re-map all our units and targeting?">
    ...
    <Accordion title="Your Google Ad Manager Account or Ours?">

    This is actually up to you! For those who don't want to be overly involved in ad operations, the simplest route to monetisation is to use Content Ignites GAM account where we pay you your revenue share each month, but you can also use your GAM account (SaaS) or even use both:
    ...
    <Accordion title='How does the second look "hybrid" setup work?'>
    ...
    <Accordion title='What is your "Fallback" feature?'>
